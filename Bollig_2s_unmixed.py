...
L_nue = 7.69
L_nuebar = 7.37 # 10^51 erg/s
R = 1.7 # 19 km
r_in= R * 1.0e+6 
e_nuebar = 20.4975 # 16.23, sqrt(<E^3>/<E>), ,<E>_nuebar = Hudepohl_11.7MeV_1sec
e_nue = 15.9641    # 13.08, sqrt(<E^3>/<E>), ,<E>_nue = Hudepohl_9.7MeV_1sec
